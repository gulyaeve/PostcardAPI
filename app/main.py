...
async def get_preview(category: str = "Базовые", template: str = "picture0"):
...
@app.get("/postcards")
async def get_postcards_by_type(category: str = "Базовые"):
...
async def get_postcard(text: str = "test", category: str = "Базовые", template: str = "picture0"):
