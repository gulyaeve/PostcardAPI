  ...
  <body>
    ...
    <script>
      window.onload = function() {{
         ...
         document.getElementById('left-p2').style.height = (Number(cenHeight) - 641) + 'px';
         document.getElementById('right-p2').style.height = (Number(cenHeight) - 656) + 'px';
